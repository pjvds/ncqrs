...
namespace Ncqrs.Specs.Eventing.Storage
{
    [TestFixture]
    public class InMemoryEventStoreSpecs
    {
        ...
        {
            public Func<IEnumerable<IEventSourcedEvent>> GetUncommittedEventsStub;
            ...
            public IEnumerable<IEventSourcedEvent> GetUncommittedEvents()
            {
