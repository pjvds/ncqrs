...
//        /// <exception cref="CommandHandlerNotFoundException">Occurs when the <see cref="ICommandExecutor"/> was not found for on the given <see cref="ICommand"/>.</exception>
...
//        /// <exception cref="ArgumentNullException">Occurs when the <i>command</i> was a <c>null</c> dereference.</exception>
//        /// <exception cref="CommandHandlerNotFoundException">Occurs when a <see cref="ICommandExecutor"/> was not found for on of the given <see cref="ICommand"/>'s.</exception>
...
//        void RegisterHandler(Type commandType, ICommandExecutor handler);
...
//        /// <param name="handler">The handler that will be called for every command of the specified type.</param>
//        /// <exception cref="ArgumentNullException">Occurs when the <i>commandType</i> or <i>handler</i> was a <c>null</c> dereference.</exception>
//        void RegisterHandler<TCommand>(ICommandExecutor handler) where TCommand : ICommand;
...
//        /// <exception cref="ArgumentNullException">Occurs when the <i>commandType</i> or <i>handler</i> was a <c>null</c> dereference.</exception>
//        void UnregisterHandler(Type commandType, ICommandExecutor handler);
//    }
...
//        public void RegisterHandler(Type commandType, ICommandExecutor handler)
//        {
//            Contract.Requires<ArgumentNullException>(commandType != null, "The commandType cannot be null.");
//            Contract.Requires<ArgumentNullException>(handler != null);
//        }

//        public void UnregisterHandler(Type commandType, ICommandExecutor handler)
//        {
//            Contract.Requires<ArgumentNullException>(commandType != null, "The commandType cannot be null.");
...
//        public void RegisterHandler<TCommand>(ICommandExecutor handler) where TCommand : ICommand
//        {
//            Contract.Requires<ArgumentNullException>(handler != null, "The handler cannot be null.");
//        }
//    }
